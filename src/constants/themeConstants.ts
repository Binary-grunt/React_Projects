...
export const themes = {
    light: {
        primaryBg: 'bg-light-theme-very-light-gray',
        secondaryBg: 'bg-light-theme-very-light-white',
        contentColor: 'bg-light-theme-light-grayish-blue',
    ...
    dark: {
        ...
        secondaryBg: 'bg-dark-theme-dark-desaturated-blue',
        contentColor: 'bg-dark-theme-medium-grayish-blue-hover',
